...
const Game = ({ navigation }) => {
    ...
    return (
        <View
            style={{
                flex: 1,
                backgroundColor: 'pink',  // Color fondo
                alignItems: 'center',
                justifyContent: 'center',
            }}>
            <Text style={{fontSize: 24, marginBottom: 20}}>Encuentra el icono :D</Text>
            <Button
            ...
            <View
                ...
                {cards.map((icon, index) => (
                    <TouchableOpacity
                        ...
                        {icon && <FontAwesomeIcon icon={icon} size={32} color="lightcoral" />}
